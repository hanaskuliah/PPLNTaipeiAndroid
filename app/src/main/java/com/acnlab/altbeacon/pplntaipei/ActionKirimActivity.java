...
public class ActionKirimActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnScan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(ActionKirimActivity.this, MainActivity.class);
        ...
        btnShowData.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(ActionKirimActivity.this, ListKirimActivity.class);
                startActivity(intent);
            }
        });
    ...
    public void onBackPressed(){
        super.onBackPressed();
        Intent intent = new Intent(ActionKirimActivity.this, HomeActivity.class);
        startActivity(intent);
        finish();
    }
